...
def main():
    ...
    in_port = mido.open_input("loopMIDI Port 0")
    ...
    for msg in in_port:
        if clock_count == 192 or msg.type == "start":
            ...
            hue = scale_between_range(mean_hsv[0], 0, 179, 10, 100)
            saturation = scale_between_range(mean_hsv[1], 0, 255, 10, 100)
            intensity = scale_between_range(mean_hsv[2], 0, 255, 10, 100)
